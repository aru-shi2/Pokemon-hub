    ...
    <div className="min-h-screen bg-yellow-100 p-4 md:p-10 flex justify-center">
      ...
      {Data && <div className="main w-full max-w-5xl bg-white rounded-xl border border-yellow-200 hover:shadow-xl transition duration-300">
        ...
        <div className="about px-6 md:px-10 py-10 grid md:grid-cols-2 gap-10">
         ...
         <div className="image bg-linear-to-br from-yellow-200 to-green-200 rounded-lg flex justify-center items-center py-12 transition duration-300 hover:from-yellow-200 hover:to-green-300"> <img src={Data.sprites.other["official-artwork"].front_default} alt="" className="w-60 object-contain transition duration-300 hover:scale-105" /> </div>
          ...
          <div>
            ...
            <div className="first flex justify-between py-3 border-b border-gray-300 hover:bg-yellow-50 transition px-2 rounded text-base md:text-lg">
            ...
            <div className="abilities mt-10">
              ...
              <ul className="flex flex-wrap gap-3">
                {Data.abilities.map((i,index)=>(
                  <li key={index} className="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-md text-sm md:text-base font-medium capitalize hover:bg-yellow-200 hover:-translate-y-0.5 transition duration-200 cursor-pointer">
                    {i.ability.name}
                  </li>
                ))}
              </ul>
        ...
        <div className="stats px-6 md:px-10 pb-10">
          ...
          <ul className="moves grid sm:grid-cols-2 md:grid-cols-3 gap-3">
            {Data?.moves?.slice(0,10).map((m,index)=>(
              <li 
                key={index} 
